...
<div class="navbar">
	...
	<h3 style="color:green; text-align:center;">Leave apply</h3>
	<div class="container" id="div1">
		<table align="center" class="table table-striped table-bordered">

			<f:form modelAttribute="leave" name="frm">
				<f:hidden path="empId" />
				<tr>
					<td>Employee Name:</td>
				</tr>
				...
				<tr>
					<td><f:input path="managerName" readOnly="true" /></td>
				</tr>
                <tr>
                   <td>From Date:</td>
                </tr>
				...
				<tr>
					<td><f:textarea path="reason" cols="30" rows="3" />
				</tr>
