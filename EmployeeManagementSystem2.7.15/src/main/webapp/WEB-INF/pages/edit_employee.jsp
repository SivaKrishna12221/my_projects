...
<div class="navbar">
    <div class="navbar-left">
        <span class="navbar-title">Employee Management System</span>
    </div>
	...
	<h1 style="color: green; text-align: center;">Edit Employee
		Details</h1>
	<br>
		...
		<table align="center" class="table table-striped table-bordered">
			<f:form modelAttribute="emp" class="form-group">
				...
				<tr>
					...
					<f:errors path="pincode" cssStyle="color:red" /></td>
